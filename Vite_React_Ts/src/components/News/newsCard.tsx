...
const NewsCard = ({ news }: NewsProp) => {
  ...
  return (
    <div className="max-w-2xl bg-white border border-gray-200 rounded-lg mx-auto sm:my-2 md:my-0 flex sm:flex-col lg:flex-row shadow-lg hover:shadow-xl transition-all delay-100">
