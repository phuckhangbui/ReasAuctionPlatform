...
namespace API.Data.Migrations
{
    ...
    [Migration("20240316162541_editPropertyInParticipateAuctionHistory")]
    partial class editPropertyInParticipateAuctionHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessObject.Entity.Account", b =>
                {
            ...
            modelBuilder.Entity("BusinessObject.Entity.Auction", b =>
                {
            ...
            modelBuilder.Entity("BusinessObject.Entity.AuctionAccounting", b =>
                {
            ...
            modelBuilder.Entity("BusinessObject.Entity.DepositAmount", b =>
                {
            ...
            modelBuilder.Entity("BusinessObject.Entity.Major", b =>
                {
                    b.Property<int>("MajorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BusinessObject.Entity.MoneyTransaction", b =>
                {
            ...
            modelBuilder.Entity("BusinessObject.Entity.MoneyTransactionType", b =>
                {
                    b.Property<int>("TypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BusinessObject.Entity.News", b =>
                {
            ...
            modelBuilder.Entity("BusinessObject.Entity.Notification", b =>
                {
            ...
            modelBuilder.Entity("BusinessObject.Entity.ParticipateAuctionHistory", b =>
                {
            ...
            modelBuilder.Entity("BusinessObject.Entity.RealEstate", b =>
                {
                    b.Property<int>("ReasId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BusinessObject.Entity.RealEstateDetail", b =>
                {
            ...
            modelBuilder.Entity("BusinessObject.Entity.RealEstatePhoto", b =>
                {
            ...
            modelBuilder.Entity("BusinessObject.Entity.Role", b =>
                {
                    b.Property<int>("RoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BusinessObject.Entity.Rule", b =>
                {
                    b.Property<int>("RuleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BusinessObject.Entity.Type_REAS", b =>
                {
            ...
            modelBuilder.Entity("BusinessObject.Entity.Account", b =>
                {
                    b.HasOne("BusinessObject.Entity.Major", "Major")
                        .WithOne()
                        .HasForeignKey("BusinessObject.Entity.Account", "MajorId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BusinessObject.Entity.Role", "Role")
                        .WithOne()
                        .HasForeignKey("BusinessObject.Entity.Account", "RoleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("BusinessObject.Entity.Auction", b =>
                {
                    b.HasOne("BusinessObject.Entity.Account", "AccountCreate")
                        .WithMany("Auctions")
                    ...
                    b.HasOne("BusinessObject.Entity.RealEstate", "RealEstate")
                        .WithOne()
                        .HasForeignKey("BusinessObject.Entity.Auction", "ReasId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("BusinessObject.Entity.AuctionAccounting", b =>
                {
                    b.HasOne("BusinessObject.Entity.Account", "AccountOwner")
                        .WithMany("OwnedAuctionAccountings")
                        .HasForeignKey("AccountOwnerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BusinessObject.Entity.Account", "AccountWin")
                        .WithMany("WonAuctionAccountings")
                        .HasForeignKey("AccountWinId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BusinessObject.Entity.Auction", "Auction")
                        .WithOne("AuctionAccounting")
                        .HasForeignKey("BusinessObject.Entity.AuctionAccounting", "AuctionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BusinessObject.Entity.RealEstate", "RealEstate")
                        .WithOne()
                        .HasForeignKey("BusinessObject.Entity.AuctionAccounting", "ReasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("BusinessObject.Entity.DepositAmount", b =>
                {
                    b.HasOne("BusinessObject.Entity.Account", "AccountSign")
                    ...
                    b.HasOne("BusinessObject.Entity.RealEstate", "RealEstate")
                        .WithOne()
                        .HasForeignKey("BusinessObject.Entity.DepositAmount", "ReasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BusinessObject.Entity.Rule", "Rule")
                        .WithOne()
                        .HasForeignKey("BusinessObject.Entity.DepositAmount", "RuleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("BusinessObject.Entity.MoneyTransaction", b =>
                {
                    b.HasOne("BusinessObject.Entity.Account", "AccountReceive")
                        .WithMany("MoneyTransactionsReceived")
                        .HasForeignKey("AccountReceiveId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BusinessObject.Entity.Account", "AccountSend")
                        .WithMany("MoneyTransactionsSent")
                        .HasForeignKey("AccountSendId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BusinessObject.Entity.DepositAmount", "DepositAmount")
                        .WithOne()
                        .HasForeignKey("BusinessObject.Entity.MoneyTransaction", "DepositId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BusinessObject.Entity.RealEstate", "RealEstate")
                        .WithOne()
                        .HasForeignKey("BusinessObject.Entity.MoneyTransaction", "ReasId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BusinessObject.Entity.MoneyTransactionType", "Type")
                        .WithOne()
                        .HasForeignKey("BusinessObject.Entity.MoneyTransaction", "TypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("BusinessObject.Entity.ParticipateAuctionHistory", b =>
                {
                    b.HasOne("BusinessObject.Entity.Account", "AccountBid")
                        .WithMany("ParticipateAuctionHistory")
                        .HasForeignKey("AccountBidId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BusinessObject.Entity.AuctionAccounting", "AuctionAccounting")
            ...
            modelBuilder.Entity("BusinessObject.Entity.RealEstate", b =>
                {
                    ...
                    b.HasOne("BusinessObject.Entity.Type_REAS", "Type_REAS")
                        .WithOne()
                        .HasForeignKey("BusinessObject.Entity.RealEstate", "Type_Reas")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("BusinessObject.Entity.RealEstateDetail", b =>
                {
                    b.HasOne("BusinessObject.Entity.RealEstate", "RealEstate")
                        .WithOne("Detail")
                        .HasForeignKey("BusinessObject.Entity.RealEstateDetail", "ReasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
